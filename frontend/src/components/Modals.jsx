    ...
    <ModalShell open={open} onClose={onClose}>
      <div className="flex items-center justify-between pb-3 border-b border-border-light">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-bold text-neutral-title">
            Operational Audit Trail
          </h3>
        </div>
        <button
          className="p-1 text-neutral-muted hover:text-neutral-title rounded-full hover:bg-surface-panel transition"
          onClick={onClose}
        >
      ...
      <div className="flex flex-col gap-3 text-xs">
        <div className="bg-surface-panel p-3.5 rounded-lg border border-border-light flex flex-col gap-1.5">
          ...
          <p className="text-neutral-title font-semibold text-sm">
            Action Execution Confirmed
          </p>
          <span className="text-neutral-muted">
            Acknowledged just now by Transport Manager (Desk Lead IST).
          </span>
        </div>
        <div className="border border-border-light rounded-lg overflow-hidden font-mono text-[11px]">
          ...
          <div className="p-3 space-y-1.5 bg-surface text-neutral-body">
            <div>
              <span className="text-neutral-muted">Timestamp:</span> {timestamp}
            </div>
            <div>
              <span className="text-neutral-muted">Operator:</span> Transport
              Manager (Role: Dispatch Ops Supervisor)
            </div>
            <div>
              <span className="text-neutral-muted">Action:</span>{' '}
              {actionTitle || 'Action Execution Confirmed'}
            </div>
            <div>
              <span className="text-neutral-muted">Governance State:</span>{' '}
              Dispatched to Vendor Extranet &amp; Mart Log
            </div>
            <div>
              <span className="text-neutral-muted">SLA State:</span> Corrective
              directive active (Grace period: 45m)
            </div>
          </div>
        </div>
      </div>
      <div className="flex justify-end pt-2">
        <button
          className="px-4 py-2 rounded-full bg-secondary text-surface text-xs font-bold hover:bg-primary-hover transition"
          onClick={onClose}
        >
          Close Audit
        </button>
    ...
    <ModalShell open={open} onClose={onClose} maxWidth="max-w-2xl">
      <div className="flex items-center justify-between pb-3 border-b border-border-light">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-bold text-neutral-title">
            Sev-1 Incident Telemetry &amp; Ack Desk
          </h3>
        </div>
        <button
          className="p-1 text-neutral-muted hover:text-neutral-title rounded-full hover:bg-surface-panel transition"
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="bg-surface-panel p-3 rounded-lg border border-border-light">
          ...
          <div className="text-xl font-bold text-neutral-title mt-0.5">
            47 min
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`text-[11px] font-medium ${inc.acked ? 'text-neutral-muted' : 'text-error'}`}
                  >
                    {inc.waiting}
                  </span>
                </div>
      ...
      <div className="flex justify-between items-center pt-2">
        <span className="text-[11px] text-neutral-muted">
          Ack SLA requires dispatcher intervention within 30 min.
        </span>
        <button
    ...
    <ModalShell open={open} onClose={onClose} maxWidth="max-w-xl">
      <div className="flex items-center justify-between pb-3 border-b border-border-light">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-bold text-neutral-title">
            Data Quality &amp; Telemetry Standard
          </h3>
        </div>
        <button
          className="p-1 text-neutral-muted hover:text-neutral-title rounded-full hover:bg-surface-panel transition"
      ...
      <div className="flex flex-col gap-3 text-xs">
        <div className="bg-success-bg/40 border border-primary/20 p-3 rounded-lg flex items-center justify-between">
          <span className="font-bold text-neutral-title">
            Pipeline Health Score: 97.8% Trust Factor
          </span>
          <span className="px-2 py-0.5 bg-success-bg text-primary font-bold text-[10px] rounded-full">
            PASSED AUDIT
          </span>
        </div>
        <div className="border border-border-light rounded-lg divide-y divide-border-light">
          <div className="p-3 flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-neutral-muted mt-0.5">
                MoveInSync and FleetOps UUIDs mapped to canonical unified key.
              </p>
            </div>
          </div>
          <div className="p-3 flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-neutral-muted mt-0.5">
                Cancelled-at-gate dispatches preserved for vendor reconciliation
                billing.
              </p>
            </div>
          </div>
          <div className="p-3 flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-neutral-muted mt-0.5">
                Tariff lines without matched distance slabs flagged to Ops
                audit, not dropped.
              </p>
            </div>
          </div>
          <div className="p-3 flex items-start gap-2.5">
            ...
            <div>
              <span className="font-bold text-neutral-title">
                Unclassified Severity Handling
              </span>
              <p className="text-neutral-muted mt-0.5">
                Null severity values default to '—' standard representation
                (never masked as 0).
              </p>
            </div>
          </div>
          <div className="p-3 flex items-start gap-2.5">
            ...
            <div>
              <span className="font-bold text-neutral-title">
                Unrated Feedback Filter
              </span>
              <p className="text-neutral-muted mt-0.5">
                Rider sessions without stars are excluded from mathematical mean
                calculations.
              </p>
            </div>
          </div>
